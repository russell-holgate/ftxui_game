...
// configuration step. It creates a namespace called `ftxui_game`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ftxui_game::cmake::project_name, ftxui_game::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ftxui_game::cmake::project_version);
      return EXIT_SUCCESS;
    }
